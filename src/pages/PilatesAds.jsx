...
const FAQS = [
  {
    ...
    a: "A maioria dos pacientes relata melhora entre a 3ª e a 4ª sessão. Resultados consistentes aparecem entre o 1º e o 3º mês, dependendo da condição e frequência.",
  },
  {
    q: "Como funciona a avaliação?",
    a: "40 minutos com um fisioterapeuta. Avalia postura, mobilidade, histórico e objetivos. Você sai com uma recomendação clara, sem compromisso de continuidade.",
  },
  {
    q: "Qual a diferença para um estúdio de pilates convencional?",
    a: "Aqui quem conduz são fisioterapeutas, não instrutores. O plano é baseado em avaliação clínica. Atendimento individual ou em trio (máx. 3 pessoas). Sócios são professores de pós-graduação.",
  },
  {
    ...
    <>
      ...
      <HeroSection>
        <HeroGrid>
          <div>
            ...
            <H1>
              A dor que não passa tem um motivo.
              <br />
              <em>E tem solução.</em>
            </H1>
            <HeroSub>
              Pilates Clínico conduzido por fisioterapeutas que são professores
              de pós-graduação. Cada sessão parte da sua avaliação clínica, não
              de uma sequência genérica.
            </HeroSub>
            <BulletList>
              <Bullet>
                <BulletIcon>✓</BulletIcon>Turmas de no máximo 3 alunos: atenção
                que você não encontra em academia
              </Bullet>
              <Bullet>
                <BulletIcon>✓</BulletIcon>Exercício prescrito para o seu corpo,
                não protocolo genérico
              </Bullet>
              <Bullet>
                <BulletIcon>✓</BulletIcon>13 fisioterapeutas, 3 são professores
                de pós-graduação
              </Bullet>
            </BulletList>
            <CtaGroup>
        ...
        <Container>
          ...
          <MotivosGrid>
            ...
            <MotivoCard>
              ...
              <p>
                Não abrimos turmas cheias. Vagas são limitadas por design,
                porque atenção real não funciona com 10 pessoas ao mesmo tempo.
              </p>
            </MotivoCard>
            <MotivoCard>
              <MotivoIcon>📋</MotivoIcon>
      ...
      <Section $alt>
        <Container>
          ...
          <SectionTitle>
            Quem cuida de você ensina quem cuida dos outros
          </SectionTitle>
          <SectionText>
            São 3 sócios-fundadores que são professores de pós-graduação em
            fisioterapia. Essa equipe de 13 fisioterapeutas trata pacientes de
            manhã e dá aula na universidade à noite. Quando você agenda aqui, o
            profissional que te atende está na fronteira da pesquisa.
          </SectionText>
          <EquipeGroupPhoto>
            <img
              src={equipeImg}
              alt="Equipe completa da INNOVA MOVIMENTO"
              loading="lazy"
            />
          </EquipeGroupPhoto>
          <EquipeBadges>
      ...
      <WaFloat
        href={waLink("Olá! Quero garantir minha vaga no Pilates Clínico.")}
        target="_blank"
        aria-label="WhatsApp"
      >
