...
const WA_DIRECT = waLink("Olá, INNOVA MOVIMENTO! Vi sobre o Pilates Clínico e quero agendar minha avaliação.");

/* ─── MODAL (não utilizado nesta versão) ─── */
...
export default function PilatesAdsWpp() {
    ...
    <>
      ...
      <Nav>
        <NavInner>
          ...
          <NavCta as="a" href={WA_DIRECT} target="_blank">Agendar Avaliação</NavCta>
        </NavInner>
      </Nav>
      ...
      <HeroSection>
        <HeroGrid>
          <div>
            ...
            <CtaGroup>
              <BtnMain as="a" href={WA_DIRECT} target="_blank">Garantir minha vaga</BtnMain>
            </CtaGroup>
            <SocialRow>
      ...
      <Section $alt>
        <Container>
          ...
          <BtnCta as="a" href={WA_DIRECT} target="_blank">Agendar Minha Avaliação</BtnCta>
        </Container>
      </Section>
      ...
      <CtaSection>
        <Container>
          ...
          <CtaBtns>
            <BtnWhite as="a" href={WA_DIRECT} target="_blank">Garantir minha vaga</BtnWhite>
            <BtnWaOutline
              href={WA_DIRECT}
              target="_blank"
            >
